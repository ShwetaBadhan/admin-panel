                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <!-- View Button -->
                                                <button class="btn btn-sm btn-info light view-btn" 
                                                ...
                                                <!-- Edit Button -->
                                                <button class="btn btn-sm btn-warning light" 
                                                        data-bs-toggle="modal"
                                                ...
                                                <!-- ✅ CC Points Button -->
                                                <button class="btn btn-sm btn-success light" 
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editCCModal{{ $product->id }}" 
                                                        title="Edit CC Points">
                                                    <i class="fas fa-coins"></i> {{ number_format($product->cc_points, 0) }}
                                                </button>
            ...
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">
                        <i class="fas fa-coins me-2"></i>CC Points: {{ $product->name }}
                    </h5>
                ...
                <div class="modal-body text-center">
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg">
                            <input type="number" name="cc_points" class="form-control text-center" 
                                   value="{{ old('cc_points', $product->cc_points) }}" min="0" step="1" required>
                            <span class="input-group-text">CC</span>
                        </div>
                        <small class="text-muted">Example: 20 CC points per product</small>
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <table class="table table-bordered">
                                                        <tr><th width="40%">Name</th><td>{{ $product->name }}</td></tr>
                                                        ...
                                                        <tr><th>CC Points</th><td><span class="badge bg-success">{{ number_format($product->cc_points, 0) }} CC</span></td></tr>
                                                        <tr><th>Stock</th><td>{{ $product->stock }}</td></tr>
                                                        <tr><th>Status</th><td><span class="badge badge-{{ $product->status ? 'success' : 'danger' }}">{{ $product->status ? 'Active' : 'Inactive' }}</span></td></tr>
                                                        <tr><th>Featured</th><td>{{ $product->featured ? 'Yes' : 'No' }}</td></tr>
                                                        @if ($product->size)<tr><th>Size</th><td>{{ $product->size }}</td></tr>@endif
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="d-flex gap-2 flex-wrap" id="currentImages{{ $product->id }}">
                                                                @foreach ($product->images ?? [] as $index => $image)
                                                                    <div class="position-relative">
                                                                        <img src="{{ asset('storage/' . $image) }}" alt="{{ $product->name }}" class="rounded" width="80" height="80" style="object-fit: cover;">
                                                                        <input type="hidden" name="remove_images[]" value="{{ $index }}" class="remove-img-{{ $index }}" style="display:none;">
                                                                        <button type="button" class="btn btn-danger btn-sm position-absolute top-0 start-100 translate-middle rounded-circle" onclick="removeImage({{ $product->id }}, {{ $index }})" style="width: 20px; height: 20px; padding: 0; font-size: 12px;">×</button>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" name="images[]" class="form-control" multiple accept="image/*" id="editImages{{ $product->id }}">
                                                            <small class="text-muted">Leave empty to keep current images</small>
                                                            <div id="editImagePreview{{ $product->id }}" class="mt-2 d-flex gap-2 flex-wrap"></div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" name="size" class="form-control" value="{{ old('size', $product->size) }}" placeholder="e.g., 800 ML">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label>Brand</label>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">₹</span>
                                                                    <input type="number" name="discount_price" class="form-control" step="0.01" value="{{ old('discount_price', $product->discount_price) }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <small class="text-muted">Current: {{ $product->cc_points }} CC</small>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                <div class="form-check">
                                                                    <input type="checkbox" name="featured" class="form-check-input" value="1" {{ old('featured', $product->featured) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="images[]" class="form-control" multiple accept="image/*" id="addImages">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>Size/Volume</label>
                                        <input type="text" name="size" class="form-control" value="{{ old('size') }}" placeholder="e.g., 800 ML">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Brand</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">₹</span>
                                            <input type="number" name="discount_price" class="form-control" step="0.01" value="{{ old('discount_price') }}">
                                        </div>
                                    </div>
                                    <!-- ✅ CC Points Field in Add Modal -->
                                    <div class="col-md-6 mb-3">
                                        <label>CC Points <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <input type="number" name="cc_points" class="form-control" 
                                                   value="{{ old('cc_points', 20) }}" min="0" step="1" required>
                                            <span class="input-group-text">CC</span>
                                        </div>
